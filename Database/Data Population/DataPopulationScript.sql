...
('Gavin', 7, 3, 1, 0, 3, 47.1, 0),('Leah', 7, 6, 1, 1, 3, 50, 1),('Maya', 7, 2, 0, 0, 3, 48.4, 1),('Kylie', 8, 4, 1, 1, 3, 69.2, 2),('Joseph', 8, 5, 1, 1, 3, 60.3, 2),
('Wyatt', 9, 1, 1, 1, 3, 43.7, 2),('Hunter', 10, 3, 1, 1, 1, 17.8, 0),('Natalie', 10, 4, 1, 1, 1, 19.5, 2),('Chase', 11, 3, 1, 0, 3, 64.8, 0),('Alexis', 11, 4, 1, 1, 3, 57.8, 2),
('Adam', 11, 5, 0, 0, 1, 23.4, 0),('Alex', 12, 1, 0, 1, 1, 18, 0),('Bella', 12, 4, 1, 1, 3, 42.8, 0),('Bailey', 12, 4, 1, 1, 3, 77.7, 2),('Johnathon', 12, 5, 0, 0, 1, 13.6, 0),
('Miles', 13, 1, 0, 1, 1, 16.3, 0),('Jasmine', 14, 4, 1, 1, 3, 79.2, 0),('Nolan', 14, 3, 1, 1, 3, 72.1, 0),('Morgan', 15, 4, 1, 0, 2, 32.9, 0);
