...
FROM dbo.func_GetPrevMiniGames(4) AS retTable
...
FROM dbo.func_GetMapNodes(1) AS retTable
	FULL OUTER JOIN (SELECT *
...
FROM dbo.func_GetMapMedia(2) AS retTable
	FULL OUTER JOIN (SELECT *
